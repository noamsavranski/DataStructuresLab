    ...
    public class Assignment2Tester {
        ...
        private static void testMyDynamicSet() {
            ...
            runSafely("testDelete", () -> {
                ...
                set.insert(a);
                set.insert(b);
                Element<String> elA = set.search(5);
                Element<String> elB = set.search(3);
                set.delete(elA);
                test("deleted search=5", set.search(5) == null,
                        "Expected null", "Got " + set.search(5));
                test("min after del", set.minimum() == elB,
                        "Expected min key=3", "Got " + (set.minimum() != null ? set.minimum().key() : "null"));
                test("max after del", set.maximum() == elB,
            ...
            runSafely("testMinMax", () -> {
                ...
                set.insert(b);
                set.insert(c);
                Element<String> elB = set.search(2);
                Element<String> elC = set.search(8);
                test("min element", set.minimum() == elB,
                        "Expected min key=2", "Got " + (set.minimum() != null ? set.minimum().key() : "null"));
                test("max element", set.maximum() == elC,
            ...
            runSafely("testSuccessorPredecessor", () -> {
                ...
                set.insert(b);
                set.insert(c);
                Element<String> elA = set.search(1);
                Element<String> elB = set.search(3);
                Element<String> elC = set.search(5);
                test("succ of 1", set.successor(elA) == elB,
                        "Expected succ key=3",
                        "Got " + (set.successor(elA) != null ? set.successor(elA).key() : "null"));
                test("succ of 3", set.successor(elB) == elC,
                        "Expected succ key=5",
                        "Got " + (set.successor(elB) != null ? set.successor(elB).key() : "null"));
                test("succ null", set.successor(elC) == null,
                        "Expected null succ", "Got " + set.successor(elC));
                test("pred of 3", set.predecessor(elB) == elA,
                        "Expected pred key=1",
                        "Got " + (set.predecessor(elB) != null ? set.predecessor(elB).key() : "null"));
                test("pred of 5", set.predecessor(elC) == elB,
                        "Expected pred key=3",
                        "Got " + (set.predecessor(elC) != null ? set.predecessor(elC).key() : "null"));
                test("pred null", set.predecessor(elA) == null,
                        "Expected null pred", "Got " + set.predecessor(elA));
            });
        }
